...
import com.example.shellinglaptopapp.tensorflowlite.tokenization.FullTokenizer;
...
public final class FeatureConverter {
  ...
  public FeatureConverter(Map<String, Integer> inputDic, boolean doLowerCase, int maxQueryLen, int maxSeqLen) {
